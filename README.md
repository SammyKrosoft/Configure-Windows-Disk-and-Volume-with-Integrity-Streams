...
For all the details about Disk supported and recommended configurations, [check this Microsoft official documentation page about disk configuration for Exchange servers here.](https://docs.microsoft.com/en-us/exchange/plan-and-deploy/deployment-ref/storage-configuration?view=exchserver-2019)
